...
class routeOpt:
    ...
    def getOptimizedRoute(self,Project="./",NumberOfPoint=0,SolverName="TSP_enum_greedy_2opt_20200307"):
        ...
        prog.write("  call obj%"+"import('"+Project+"/AddressList.txt')\n")
        prog.write("  ! optimize route by solving a TS problem.\n")
        prog.write('  call obj%'+'run(SolverName="'+SolverName+'",NumOfPoints='+str(NumberOfPoint)+')\n')
        prog.write('  call obj%'+'run(SolverName="'+SolverName+'",NumOfPoints='+str(NumberOfPoint)+')\n')
        prog.write('  ! export route\n')
        prog.write('  call obj%'+'export(Repository="'+Project+'")\n')
...
class plantFEM(prepro,solver,pospro):

    def __init__(self):
        self.ProjName="log_plantFEM"
        self.prepro=prepro()
        self.solver=solver()
        self.pospro=pospro()
