...
!    X(1:4)   = (/  0.0d0,  0.0d0,  0.0d0, 0.0d0 /)
    ...
    print *, "Solved by GaussSeidel","/",t2-t1," sec.",solver%x(100)
...
!    X(1:4)   = (/  0.0d0,  0.0d0,  0.0d0, 0.0d0 /)
    ...
    print *, "Solved by BiCGSTAB(CRS)","/",t2-t1," sec.",solver%x(100)
...
!    X(1:4)   = (/  0.0d0,  0.0d0,  0.0d0, 0.0d0 /)
    ...
    print *, "Solved by BiCGSTAB   ","/",t2-t1," sec.",solver%x(100)
!    X(1:4)   = (/  0.0d0,  0.0d0,  0.0d0, 0.0d0 /)
    call solver%import(a = Amat, x = Xvec, b = Bvec)
    call cpu_time(t1)  
    ...
    print *, "Solved by GPBiCG     ","/",t2-t1," sec.",solver%x(100)
