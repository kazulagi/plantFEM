program main
    ...
    call Permiability%create(Name="Permiability",ParaValue=0.0010d0,Layer=1)
    ...
    z_max=100.0d0,z_min=65.0d0,BoundValue=0.0d0,Layer=1,Name="disp_x")
    call disp_y%create(Category="Dirichlet",x_max=100.0d0,x_min=-100.0d0,y_max=100.0d0,y_min=-100.0d0,&
    z_max=100.0d0,z_min=65.0d0,BoundValue=0.0d0,Layer=2,Name="disp_y")
    call disp_z%create(Category="Dirichlet",x_max=100.0d0,x_min=-100.0d0,y_max=100.0d0,y_min=-100.0d0,&
    z_max=100.0d0,z_min=65.0d0,BoundValue=0.0d0,Layer=3,Name="disp_z")
    
    call disp_x%create(Category="Dirichlet",x_max=100.0d0,x_min=-100.0d0,y_max=100.0d0,y_min=-100.0d0,&
    z_max=5.0d0,z_min=0.0d0,BoundValue=0.0d0,Layer=1,Name="disp_x")
    call disp_y%create(Category="Dirichlet",x_max=100.0d0,x_min=-100.0d0,y_max=100.0d0,y_min=-100.0d0,&
    z_max=5.0d0,z_min=0.0d0,BoundValue=0.0d0,Layer=2,Name="disp_y")
    call disp_z%create(Category="Dirichlet",x_max=100.0d0,x_min=-100.0d0,y_max=100.0d0,y_min=-100.0d0,&
    z_max=5.0d0,z_min=0.0d0,BoundValue=0.0d0,Layer=3,Name="disp_z")
    ...
    call seed%run(timestep=1000,dt=1000.0d0,SolverType="BiCGSTAB",&
        Display=.true.,nr_tol=1.0d0,infinitesimal=.true.)
