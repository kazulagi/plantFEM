program Preprocessing
    ...
    call leaf%SetBC(Dirichlet=.true., ymax=-1.0d0, ymin=-25.0d0,  val=0.0d0,val_id=1)
    call leaf%SetBC(Dirichlet=.true., ymax=-1.0d0, ymin=-25.0d0,  val=0.0d0,val_id=2)
    call leaf%SetBC(Dirichlet=.true., ymax=-1.0d0, ymin=-25.0d0,  val=0.0d0,val_id=3)
