...
cube_p(1)%femdomainp => cube(1)
cube_p(2)%femdomainp => cube(2)
cube_p(3)%femdomainp => cube(3)

call solver%init(NumDomain=3)
call solver%setDomain(FEMDomainPointers=cube_p(:))
